...
class LunaChatterbox:
    ...
    def __init__(self, reference_dir: str, device: str = None):
    ...
    def speak(
        ...
        wav = self.model.generate(
            text=text, audio_prompt_path=ref, exaggeration=exaggeration
        )
...
def get_luna_tts(engine: str = "chatterbox", model_dir: str = None, device: str = None):
    """
