...
class AudioComparator:
    def __init__(
        ...
        logger.info(
            f"AudioComparator initialized (model: {whisper_model_size}, device: {device})"
        )
        ...
        try:
            ...
            if sample_rate != 16000:
                ...
                number_of_samples = round(
                    len(audio_float32) * float(16000) / sample_rate
                )
    ...
    def format_comparison(
        self, comparisons: List[Tuple[str, str]], score: float
    ) -> str:
        color_map = {
            "correct": "green",
            "similar": "yellow",
